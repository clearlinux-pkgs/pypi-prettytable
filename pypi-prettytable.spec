...
Source0  : https://files.pythonhosted.org/packages/3b/8a/de4dc1a6098621781c266b3fb3964009af1e9023527180cb8a3b0dd9d09e/prettytable-3.12.0.tar.gz
...
%prep
%setup -q -n prettytable-3.12.0
cd %{_builddir}/prettytable-3.12.0
pushd ..
cp -a prettytable-3.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730321746
