...
Source0  : https://files.pythonhosted.org/packages/89/c1/3043e85bf06f252f51817dad51a37368daaf7b1c101b43cd5aa6100f09b1/prettytable-3.1.1.tar.gz
...
%prep
%setup -q -n prettytable-3.1.1
cd %{_builddir}/prettytable-3.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645043526
...
cp %{_builddir}/prettytable-3.1.1/COPYING %{buildroot}/usr/share/package-licenses/pypi-prettytable/5c51c5dac61ba4be822af5e4dbfbdc9aaac1a2b1
