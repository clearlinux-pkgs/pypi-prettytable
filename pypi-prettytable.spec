...
Source0  : https://files.pythonhosted.org/packages/cb/7d/7e6bc4bd4abc49e9f4f5c4773bb43d1615e4b476d108d1b527318b9c6521/prettytable-3.2.0.tar.gz
...
%prep
%setup -q -n prettytable-3.2.0
cd %{_builddir}/prettytable-3.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1646664500
...
cp %{_builddir}/prettytable-3.2.0/COPYING %{buildroot}/usr/share/package-licenses/pypi-prettytable/5c51c5dac61ba4be822af5e4dbfbdc9aaac1a2b1
