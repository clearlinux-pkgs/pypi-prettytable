...
Version  : 3.1.0
Release  : 75
URL      : https://files.pythonhosted.org/packages/01/55/a4a1a0f73f7665744cd5712fd6f982e5406c8e7459a0730a69299a3c1e2b/prettytable-3.1.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/01/55/a4a1a0f73f7665744cd5712fd6f982e5406c8e7459a0730a69299a3c1e2b/prettytable-3.1.0.tar.gz
...
%prep
%setup -q -n prettytable-3.1.0
cd %{_builddir}/prettytable-3.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644863302
...
cp %{_builddir}/prettytable-3.1.0/COPYING %{buildroot}/usr/share/package-licenses/pypi-prettytable/5c51c5dac61ba4be822af5e4dbfbdc9aaac1a2b1
