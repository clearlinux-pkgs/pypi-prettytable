...
Source0  : https://files.pythonhosted.org/packages/4c/90/e1c8c06235d53c3adaae74d295669612beea5f5a2052b3184a763e7bdd62/prettytable-3.10.2.tar.gz
...
%prep
%setup -q -n prettytable-3.10.2
cd %{_builddir}/prettytable-3.10.2
pushd ..
cp -a prettytable-3.10.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720800076
