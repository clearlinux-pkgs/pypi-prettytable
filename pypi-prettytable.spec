...
Source0  : https://files.pythonhosted.org/packages/10/88/ef38a6e4bc375600d3031e405a8d3b3dc4a154fccffd21d5d06e66c96230/prettytable-3.3.0.tar.gz
...
%prep
%setup -q -n prettytable-3.3.0
cd %{_builddir}/prettytable-3.3.0
pushd ..
cp -a prettytable-3.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656395480
...
cp %{_builddir}/prettytable-3.3.0/COPYING %{buildroot}/usr/share/package-licenses/pypi-prettytable/5c51c5dac61ba4be822af5e4dbfbdc9aaac1a2b1
