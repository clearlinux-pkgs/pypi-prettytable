...
Source0  : https://files.pythonhosted.org/packages/71/19/d65d4c39aa12a5630a8aa02ead8324cfaae3217146b19dd25d88d763bbdf/prettytable-3.0.0.tar.gz
...
%prep
%setup -q -n prettytable-3.0.0
cd %{_builddir}/prettytable-3.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641941080
...
cp %{_builddir}/prettytable-3.0.0/COPYING %{buildroot}/usr/share/package-licenses/pypi-prettytable/5c51c5dac61ba4be822af5e4dbfbdc9aaac1a2b1
