...
Source0  : https://files.pythonhosted.org/packages/19/d3/7cb826e085a254888d8afb4ae3f8d43859b13149ac8450b221120d4964c9/prettytable-3.10.0.tar.gz
...
%prep
%setup -q -n prettytable-3.10.0
cd %{_builddir}/prettytable-3.10.0
pushd ..
cp -a prettytable-3.10.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708368625
